...
# 绘制特征重要性条形图
plt.figure()
plt.bar(range(X_train.shape[1]), regressor.feature_importances_)
...
# # plt.scatter(X_train, regressor.predict(X_train), s=30, edgecolor="black", c="blue", label="predict")
#
# X_train = X_train[X_train[:, 0].argsort()]
#
# plt.plot(X_train, regressor.predict(X_train), color="cornflowerblue", label="max_depth=3", linewidth=1.5, marker='o')
# plt.xlabel("data")
# plt.ylabel("target")
